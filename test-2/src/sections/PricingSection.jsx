...
const PricingSection = () => {
  return (
    <div id="pricing" className="relative mt-32 overflow-x-clip">
      <div className="flex flex-col container mx-auto px-4 w-full">
        <div className="flex flex-col text-center gap-6">
          <h1 className="text-5xl font-medium">PRICING PLANS</h1>
        </div>
        <div className="flex mt-10 gap-8 justify-between">
          {PLANS.map((plan) => (
            <div
              className={clsx(
